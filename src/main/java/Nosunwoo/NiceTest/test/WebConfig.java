    ...
    public class WebConfig implements WebMvcConfigurer {
        ...
        public void addCorsMappings(CorsRegistry registry) {
            ...
            registry.addMapping("/**")
                    .allowedOrigins("http://3.39.62.170:80","https://3.39.62.170:443","http://127.0.0.1:5500","http://github-action-s3-list-app.s3-website.ap-northeast-2.amazonaws.com","http://localhost:8080", "http://localhost:5173","http://localhost:8081", "http://localhost:3000", "http://github-action-chatting-app.s3-website.ap-northeast-2.amazonaws.com","http://kim-maru.com") // 허용할 출처 추가
